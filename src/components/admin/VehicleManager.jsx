...
const emptyForm = {
  ...
  emissionClass: "", co2Emission: "", autoscoutUrl: "", color: "", paintType: "", interiorColor: "",
...
function fromVehicle(vehicle) {
  return {
    ...
    co2Emission: vehicle.co2_emission ?? "", autoscoutUrl: vehicle.energy_label || "", color: vehicle.color || "",
